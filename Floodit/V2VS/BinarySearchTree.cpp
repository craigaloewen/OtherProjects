...
typedef BinarySearchTree::BSTDataType BSTDataType;

BinarySearchTree::Node::Node(BSTDataType newval)
{
	val = newval;
	left = NULL;
	right = NULL;
...
bool BinarySearchTree::insert(BSTDataType val)
{
...
bool BinarySearchTree::remove(BSTDataType val)
{
	if (root_ == NULL) {
		return false;
	} else if(!exists(val)) {
...
bool BinarySearchTree::exists(BSTDataType val) const
{
...
BSTDataType BinarySearchTree::minFunction() const
{
    if (root_ == NULL) {
    	return 0;
    } else {
...
BSTDataType BinarySearchTree::maxFunction() const
{
    if (root_ == NULL) {
    	return 0;
    } else {
